...
COLLECT_CURRENT_LOCATION = 43  # For missing persons
__all__ = [
    ...
    'CHOOSING_LOCATION', 'SELECT_URGENCY', 'UPDATE_REPORT_STATUS', 
    'CHOOSE_STATUS', 'COLLECT_NAME', 'COLLECT_AGE', 'COLLECT_GENDER',
    'COLLECT_DESCRIPTION', 'COLLECT_LAST_SEEN_LOCATION', 'COLLECT_LAST_SEEN_TIME',
    'COLLECT_MEDICAL_INFO', 'COLLECT_CONTACT_INFO', 'COLLECT_EXACT_LOCATION',
